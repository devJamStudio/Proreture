<div class="{{ $block->classes }}">
  <div id="hero" class="relative flex  items-center flex-col bg-opacity justify-center min-h-screen bg-cover " >
    ...
    @if ($header)
    <h1 class="mx-auto relative z-[5] max-w-prose px-4  mb-3 tracking-wider	 uppercase text-lg sm:text-2xl md:text-3xl lg:text-5xl outline-blue-500 text-white text-center "> {!! $header !!}</h1>
    @endif
    @if ($button)
